...
public class ResetPasswordSecond2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_password_second2);
    ...
    {
        final RequestQueue requestQueue = Volley.newRequestQueue(ResetPasswordSecond2.this);

        progressdialog = new ProgressDialog(ResetPasswordSecond2.this);
    ...
    public void pullAlert(String body){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(ResetPasswordSecond2.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(ResetPasswordSecond2.this);
        }
        builder.setTitle("Message")
                .setMessage(body)
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        intent = new Intent(ResetPasswordSecond2.this, LoginActivity.class);
                        startActivity(intent);
                        ResetPasswordSecond2.this.finish();
                    }
                })
                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        intent = new Intent(ResetPasswordSecond2.this, DashboardActivity.class);
                        startActivity(intent);
                        ResetPasswordSecond2.this.finish();
                    }
                })
